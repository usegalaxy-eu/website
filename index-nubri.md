...
website: https://nubri.usegalaxy.eu
subdomain: nubri
...
<table border="0"><tr>
    <td width="11%">
        <img alt="National University Biomedical Research Institute (NUBRI) Logo" src="/assets/media/nubri-logo.jpg" />
    </td>
    <td width="8%">
        <img alt="National University–Sudan Logo" src="/assets/media/nubri-nusu-logo.png" />
    </td>
</tr>
</table>
