...
website: https://ssh.usegalaxy.eu
subdomain: ssh
---
...
{:.no_toc}
<br>
The **SSH Galaxy** workbench is the place to go for anything materials science in Galaxy! The workbench is based on the [Galaxy framework](https://galaxyproject.org){:target="_blank"},
